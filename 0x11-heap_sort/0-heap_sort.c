...
/**
 * maxHeapify - function to find max value of Heap
 * @maxHeap: Struct of MaxHeap
 * @idx: variable index
 * @size: Array size
 */
...
/**
 * createAndBuildHeap - function to build a Heap
 * @array: array data
 * @size: array size
 * Return: Struct maxHeap
 */
